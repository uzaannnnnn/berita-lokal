...
const ApprovedAdmin: React.FC<DashboardProps> = ({ user }) => {
  ...
  const { newsData, isLoading } = useFetchNews(1000, "approved", "", "", "");
        ...
        <header className="mx-4 mt-4 flex items-center justify-between rounded-2xl border border-white/70 bg-white/80 px-4 py-3 shadow-sm backdrop-blur lg:mx-8">
          <div>
            ...
            <p className="text-xs text-slate-500">
              Arsip berita yang sudah melewati moderasi
            </p>
          </div>
          ...
          <div className="mt-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Pantau berita yang sudah siap tayang.
              </p>
            </div>
